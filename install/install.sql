...
(
    `K` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT 'cache',
    `V` longtext CHARACTER SET utf8,
    PRIMARY KEY (`K`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8mb4;
...
(
    ...
    `content`  text,
    `superior` int(255)     DEFAULT '-1' COMMENT '上级分类ID，如果是-1则是1级分类',
...
INSERT INTO `sky_class` (`cid`, `sort`, `name`, `image`, `grade`, `content`, `superior`, `state`, `support`, `date`)
VALUES (1, 2, '默认分类', 'https://api.ixiaowai.cn/api/api.php', 1, '', -1, 1, '1,1,1,1,1', '2022-08-04 17:17:58');


DROP TABLE IF EXISTS `sky_config`;
CREATE TABLE `sky_config`
(
    `K` varchar(255) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `sky_price` (`mid`, `sort`, `name`, `content`, `priceis`, `pointsis`, `rule`, `ActualProfit`,
                         `ProfitThreshold`, `money`, `state`, `addtime`)
VALUES (1, 1, '普通用户', '普通用户，和游客没什么区别!', '30', '3000', 1, '50', '20', 0.00, 1, '2022-08-24 11:00:43');
INSERT INTO `sky_price` (`mid`, `sort`, `name`, `content`, `priceis`, `pointsis`, `rule`, `ActualProfit`,
                         `ProfitThreshold`, `money`, `state`, `addtime`)
...
(
    ...
    `endtime`       datetime          DEFAULT NULL COMMENT '权限到期时间',
