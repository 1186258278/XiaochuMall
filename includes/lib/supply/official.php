...
class official
{
    ...
    public static $Config = [
        ...
        'BatchShelves' => 1, //批量上架
        'help' => '可打开服务端：<a href="https://cdn.79tian.com/api/wxapi/view/login.php"
                     target="_blank">打开</a>，用户中心->对接密钥 内获取自己的密钥来进行对接！<br>默认对接节点：<font color="red">http://hyapi.79tian.com/</font> ，复制后填写至下方即可，若节点失效，可联系官方客服获取最新节点！',
        'ip' => 1,
        'field' => [ //添加货源的字段名称
            'url' => [
                'name' => '节点域名',
