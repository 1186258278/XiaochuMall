...
<div class="card">
    ...
    <div class="card-body mdui-p-a-0">
        <div id="Se1" class="mdui-p-a-2 layui-form">
            ...
            <div class="form-group mb-3">
                <label for="example-input-normal" style="font-weight: 500">客服JS代码或IP统计代码,音乐播放器JS代码，都可以放到里面</label>
        ...
        <div id="Se5" class="mdui-p-a-2 layui-form">
            ...
            <div class="form-group mb-3" style="">
                <label for="example-input-normal"
                       style="position: relative;bottom: 0;left: 0">强制同步调用钩子列表（多个钩子使用|分隔）</label>
